...
export const WINDOWS_VC_RUNTIME_ERROR_MESSAGE = `当前 Windows 缺少 Microsoft Visual C++ 2015-2022 x64 运行库，无法加载微信数据库组件。请下载安装后重新启动 Wemento：${WINDOWS_VC_RUNTIME_DOWNLOAD_URL}`
